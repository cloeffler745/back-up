...
def is_contig(category):
        category = category.lower()
        if category == 'contig' or category == 'scaffold' or category == 'supercont' or category == 'unitig_' or category == 'nw_' or category == 'nt_':
                return True
        else:
                return False
...
def is_chromosome(category):
        category = category.lower()
        if category == 'chr' or category == 'complete' or category == 'nc_':
                return True
        else:
                return False
