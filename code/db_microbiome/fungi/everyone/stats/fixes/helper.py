...
def is_contig(category):
		if category == 'contig' or category == 'scaffold' or category == r'\bpartial\b' or category == 'supercont' or category == 'scfld' or category == r'scf_[0-9]' or category == r'scf[0-9]' or category == r'ctg_[0-9]' or category == r'unitig_[0-9]' or category == r'cont[0-9]' or category == r'ctg[0-9]' or category == r'_sf_[0-9]' or category == 'NW_' or category == 'NT_':
			return True
		else:
			return False
