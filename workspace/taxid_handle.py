...
def get_ids(taxid, other, n):
	...
	if not l_i or not l_r:
		other.append(taxid) # ...take advantage of pass by object reference and put entry into manual_handle
		return []
...
new_entry = get_ids(taxid, special_handle, nope)
