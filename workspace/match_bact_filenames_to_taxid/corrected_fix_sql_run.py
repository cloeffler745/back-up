...
sql_table_PATRIC = pd.read_sql_query("SELECT FILENAME FROM SPECIESDB WHERE DBNAME = 'PATRIC' AND GIVENTAXID IS NULL;", datab)
sql_table_REFSEQ = pd.read_sql_query("SELECT FILENAME FROM SPECIESDB WHERE DBNAME = 'REFSEQ' AND GIVENTAXID IS NULL;", datab)
sql_table_ENSEMBL = pd.read_sql_query("SELECT FILENAME FROM SPECIESDB WHERE DBNAME = 'ENSEMBL' AND GIVENTAXID IS NULL;", datab)
